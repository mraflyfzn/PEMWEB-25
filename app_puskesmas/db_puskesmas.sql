...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Bulan Mei 2025 pada 10.13
...
(4, '2025_05_23_072838_add_timestamps_to_db_puskesmas', 2);
...
INSERT INTO `paramedik` (`id`, `nama`, `gender`, `tmp_lahir`, `tgl_lahir`, `kategori`, `telpon`, `alamat`, `unit_kerja_id`, `created_at`, `updated_at`) VALUES
(1, 'Sambo', 'L', 'Depok', '2006-03-29', 'dokter', '089514801984', 'Jln. Pakis', 1, '2025-05-23 07:53:03', '2025-05-23 07:53:03');
...
(3, '011015', 'Ahmad Syauqi Raihan', 'Depok', '2006-03-29', 'L', 'syqrhnn@gmail.com', 'Jln. sawangan', 2);
...
(1, 'Poli Umum', '2025-05-23 07:29:57', '2025-05-23 07:29:57');
...
ALTER TABLE `paramedik`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unit_kerja_id` (`unit_kerja_id`);
